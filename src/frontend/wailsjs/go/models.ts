export namespace api {
	...
	export class SelectContextRequest {
	    ...
	    static createFrom(source: any = {}) {
	        return new SelectContextRequest(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.repoRoot = source["repoRoot"];
	        this.seedFile = source["seedFile"];
	        this.question = source["question"];
	...
	export class SelectedFileDTO {
	    path: string;
	    tokens: number;
	    reasons: InclusionReasonDTO[];
	
	    static createFrom(source: any = {}) {
	        return new SelectedFileDTO(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.reasons = this.convertValues(source["reasons"], InclusionReasonDTO);
	    }
	...
	export class SelectContextResponse {
	    files: SelectedFileDTO[];
	    totalTokens: number;
	    ...
	    static createFrom(source: any = {}) {
	        return new SelectContextResponse(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.files = this.convertValues(source["files"], SelectedFileDTO);
